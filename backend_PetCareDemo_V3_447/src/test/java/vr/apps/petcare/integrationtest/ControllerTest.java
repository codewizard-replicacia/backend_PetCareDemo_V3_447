...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("PetCareDemo_V3", n.getAttribute("Namespace"));
  ...
  void  testCreatePetServiceInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCareDemo_V3/PetServices")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareDemo_V3/PetServices?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/PetCareDemo_V3/PetServices/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareDemo_V3/PetOwners?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareDemo_V3/PetOwners/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreatePetCareCenterInstance() throws IOException {
    given()
        ...
        .when()
        .post("/PetCareDemo_V3/PetCareCenters")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareDemo_V3/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareDemo_V3/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PetCareDemo_V3/Documents?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PetCareDemo_V3/Documents/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
